...
MONGODB_PORT: Final[str] = cast(str, getenv("MONGODB_PORT")) if getenv("MONGODB_PORT") else "27017"
MONGODB_USERNAME: Final[str] = cast(str, getenv("MONGODB_USERNAME")) if getenv("MONGODB_USERNAME") else "bot"
